...
export default function Footer() {
  ...
  return (
    <footer className="mt-auto border-t border-slate-800 bg-slate-900/80 text-slate-100 text-sm">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          <div className="flex flex-col gap-3">
            <h4 className="font-semibold text-slate-100">Informações Legais</h4>
            <ul className="space-y-1 text-xs text-slate-100 leading-relaxed">
        ...
        {/* Divisor Inferior */}
        <div className="mt-12 border-t border-slate-900 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-100">
